                            ...
                            <form method="POST" action="{{ Route ('video') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="video" placeholder="Выбрать изображение" value="">
                                        <input type="hidden" class="form-control" name="video"  value="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>
                                        <input type="text" class="form-control" name="Text" placeholder="Основной текст" value="">
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label>
                                        <input type="text" class="form-control" name="SmallText" placeholder="Вспомогательный текст" value="">
                                    </label>
                                </div>
                                <div class="container">
